...
class Objective(object):
    ...
    def __call__(self, trial):
        ...
        # get the data
        train_loader = data.create_dataset('train', self.seed, f_prop, f_off, 
                                           f_prop_norm, f_params, features, 
                                           self.batch_size, shuffle=True, 
                                           num_workers=num_workers)
        valid_loader = data.create_dataset('valid', self.seed, f_prop, f_off, 
                                           f_prop_norm, f_params, features,
...
input_size         = len(features) #number of subhalo properties
